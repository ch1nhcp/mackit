...
export const apps: App[] = [
    ...
    },
    {
        ...
        type: 'cask',
        category: 'utilities',
        description: { en: 'Vietnamese input method', vi: 'Bộ gõ tiếng Việt' },
    ...
    },
    {
        ...
        category: 'utilities',
        description: {
            en: 'Open-source Vietnamese input method',
            vi: 'Bộ gõ tiếng Việt mã nguồn mở',
        },
        homepage: 'https://openkey.vn',
    },
    {
        id: 'xkey',
        name: 'Xkey',
        type: 'cask',
        category: 'utilities',
        description: { en: 'Lightweight Vietnamese input method', vi: 'Bộ gõ tiếng Việt nhẹ' },
        homepage: 'https://github.com/duybt/Xkey',
    },
    {
        id: 'figma',
        name: 'Figma',
